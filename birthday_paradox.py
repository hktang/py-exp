...
def rand_date():
    ...
    o = "%02d/%02d" % (m, d)
    if (o != "02/30" and o != "02/31" and o != "04/31" 
        and o != "06/31" and o != "09/31" and o != "11/31"):
        return o
    else:
        return rand_date()
...
def have_same_date(i):
    '''For a random list consisting of i dates, return 1 if one duplicate 
...
'''
Uncomment the second last line to run. Warnning! RAM hog below. 
Run at your own risk, or consider reducing the y value.
